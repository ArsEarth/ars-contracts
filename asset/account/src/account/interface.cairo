...
trait IPublicKey<TState> {
    ...
    fn debug_upgrade_result(self: @TState) -> felt252;
    fn upgrade(ref self: TState, new_class_hash: ClassHash);
    fn set_public_key(ref self: TState, issur_public_key: felt252, issuer: felt252, new_public_key: felt252, key_platform: felt252, r: felt252, g: felt252);
}
