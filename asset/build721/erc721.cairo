...
mod ERC721 {
    ...
    impl IERC721Impl of super::IERC721<ContractState> {
        ...
        fn mint(ref self: ContractState, recipient: ContractAddress) {
            ...
            let token_id = self._countId.read() + 1;
            self._set_countId(token_id);
    ...
    // function _safeMint(address to, u256 tokenId)
    ...
    impl StorageImpl of StorageTrait {
        ...
        fn _set_countId(ref self: ContractState, id: u256) {
            self._countId.write(id);
        }
